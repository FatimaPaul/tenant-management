      ...
      <Box sx={root(open)}>
              ...
              open
                ? setupItems.map((label) => (
                    <ListItemButton key={label} sx={navItemButton}>
                      ...
                      <ListItemText
                        primary={label}
                        primaryTypographyProps={{ sx: navItemText }}
                      />
                    </ListItemButton>
                  ))
                : ""
          ...
          <Box sx={configGroup}>
            {open && (
              <Box sx={navGroupHeader}>
                <Box
                  component="img"
                  src="/assets/icon-config-setting.png"
                  alt=""
                  sx={navGroupIcon}
                />
                <Typography variant="caption" sx={navGroupTitle}>
        ...
        <Box sx={bottomArea(open)}>
          <Box
            component="img"
            src={
              open ? "/assets/top-yacht.png" : "/assets/bottom-collapsed.png"
            }
            alt={open ? "Top Yacht" : ""}
            sx={bottomImage}
          />
